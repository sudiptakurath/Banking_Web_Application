...
public class BeneficiaryController {
    ...
    public ResponseEntity<Boolean> checkBeneficiaryExists(@PathVariable Integer userId, @PathVariable Long accountNumber) {
        boolean beneficiaryExists = beneficiaryService.checkBeneficiaryExists(userId, accountNumber);
